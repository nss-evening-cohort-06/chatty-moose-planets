...
const ConvertMessageObjectToMessageString = (MessageObject) => {
	...
	MessageString += `<div class="message row col-md-8"> ${user} ${time}<div class="editableText" id="message${MessageId}">${message}</div><button class="editButton btn btn-default navbar-btn">Edit</button><button type="button" class="deletebtn btn btn-default navbar-btn">Delete</button></div>`;
